...
const listings = [
  { id: 1, name: "Kwame's Tow Services", location: "Accra, Greater Accra", type: "Flatbed", capacity: "3.5 tonnes", rating: 4.8, reviews: 124, price: "GH₵ 350/trip", available: true, initials: "KT", region: "Greater Accra", phone: "+233 24 123 4567" },
  { id: 2, name: "Ashanti Heavy Haul", location: "Kumasi, Ashanti", type: "Heavy Duty", capacity: "12 tonnes", rating: 4.6, reviews: 89, price: "GH₵ 800/trip", available: true, initials: "AH", region: "Ashanti", phone: "+233 20 987 6543" },
  { id: 3, name: "Cape Coast Rescue", location: "Cape Coast, Central", type: "Wheel-Lift", capacity: "2.5 tonnes", rating: 4.9, reviews: 67, price: "GH₵ 280/trip", available: false, initials: "CR", region: "Central", phone: "+233 27 456 7890" },
  { id: 4, name: "Volta Towing Co.", location: "Ho, Volta", type: "Flatbed", capacity: "4 tonnes", rating: 4.3, reviews: 42, price: "GH₵ 400/trip", available: true, initials: "VT", region: "Volta", phone: "+233 26 321 0987" },
  { id: 5, name: "Tema Port Haulers", location: "Tema, Greater Accra", type: "Carrier", capacity: "8 tonnes", rating: 4.7, reviews: 156, price: "GH₵ 600/trip", available: true, initials: "TP", region: "Greater Accra", phone: "+233 24 555 6789" },
  { id: 6, name: "Northern Star Recovery", location: "Tamale, Northern", type: "Rollback", capacity: "5 tonnes", rating: 4.4, reviews: 38, price: "GH₵ 450/trip", available: true, initials: "NS", region: "Northern", phone: "+233 20 112 3344" },
  { id: 7, name: "Takoradi Tow Masters", location: "Takoradi, Western", type: "Heavy Duty", capacity: "15 tonnes", rating: 4.5, reviews: 73, price: "GH₵ 950/trip", available: false, initials: "TM", region: "Western", phone: "+233 27 998 7766" },
  { id: 8, name: "Koforidua Quick Tow", location: "Koforidua, Eastern", type: "Wheel-Lift", capacity: "2 tonnes", rating: 4.2, reviews: 29, price: "GH₵ 250/trip", available: true, initials: "KQ", region: "Eastern", phone: "+233 26 443 2211" },
  { id: 9, name: "Sunyani Express Tow", location: "Sunyani, Bono", type: "Flatbed", capacity: "3 tonnes", rating: 4.1, reviews: 19, price: "GH₵ 320/trip", available: true, initials: "SE", region: "Bono", phone: "+233 24 667 8899" },
  { id: 10, name: "Obuasi Road Rescue", location: "Obuasi, Ashanti", type: "Rollback", capacity: "4.5 tonnes", rating: 4.7, reviews: 51, price: "GH₵ 380/trip", available: true, initials: "OR", region: "Ashanti", phone: "+233 20 776 5544" },
  { id: 11, name: "Wa Carriers Ltd.", location: "Wa, Upper West", type: "Carrier", capacity: "10 tonnes", rating: 4.0, reviews: 14, price: "GH₵ 700/trip", available: false, initials: "WC", region: "Upper West", phone: "+233 27 889 0011" },
  { id: 12, name: "Bolga Breakdown Aid", location: "Bolgatanga, Upper East", type: "Flatbed", capacity: "3 tonnes", rating: 4.3, reviews: 22, price: "GH₵ 300/trip", available: true, initials: "BB", region: "Upper East", phone: "+233 26 112 3355" },
];
